 ...
 function bdcom_format_onu_row($onu, $actions=false) {
	...
	if ($actions) {
		...
		form_selectable_cell("<img src='" . $config['url_path'] . "plugins/bdcom/images/term.png' onClick='show_ping_w(" . '"' . $onu["onu_ipaddr"] . '"' . ")' onMouseOver='style.cursor=" . '"' . "pointer" . '"' . "' align='absmiddle' /img> " . 
			 ...
			 ($onu["ip_local_graph_id"]==0 ? '' : " <a class='linkEditMain' href='". htmlspecialchars($config['url_path'] . "graph_ip_view.php?action=preview&host_id=0&graph_template_id=0&snmp_index=&filter=" . $onu['onu_ipaddr'] ) . "'><img src='" . $webroot . "images/view_graphs.gif' border='0' alt='' title='View Graph' align='absmiddle'></a>") . 
		...
		//name
		form_selectable_cell((strlen(get_request_var('filter')) ? preg_replace("/(" . preg_quote(get_request_var('filter')) . ")/i", "<span style='background-color: #F8D93D;'>\\1</span>", $onu["onu_name"]) : $onu["onu_name"]) . "</a>" . (false ? '' : " <a class='linkEditMain' href='". htmlspecialchars($config['url_path'] . "graph_ip_view.php?action=preview&host_id=" . $onu['id'] . "&graph_template_id=0&snmp_index=&filter=" . $onu["onu_name"] ) . "'><img src='" . $webroot . "images/view_graphs.gif' border='0' alt='' title='View Graph' align='absmiddle'></a>") , $onu["onu_id"]);
		//descr
		...
		form_selectable_cell((strlen(get_request_var('filter')) ? preg_replace("/(" . preg_quote(get_request_var('filter')) . ")/i", "<span style='background-color: #F8D93D;'>\\1</span>", $onu["epon_name"]) : " <a class='linkEditMain' href=bdcom_view_epons.php?report=epons&device_id=" . $onu['device_id'] . "&port_number=" . $onu["epon_index"]) . ">" . $onu["epon_name"] . 
			" <a class='linkEditMain' href='". htmlspecialchars($config['url_path'] . "graph_ip_view.php?action=preview&host_id=" . $onu['id'] . "&snmp_index=" . $onu["epon_index"] . "&graph_template_id=0&filter=") . "'><img src='" . $webroot . "images/view_graphs.gif' border='0' alt='' title='View Graph' align='absmiddle'></a>", $onu["onu_id"] );
		//distance
